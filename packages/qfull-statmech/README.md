...
QFull-StatMech — equilibrium and non-equilibrium statistical mechanics, kinetic Monte-Carlo, Boltzmann transport.
...
declare optional dependencies on `qfull-statmech` even though it ships no code.
