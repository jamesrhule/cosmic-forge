...
QFull-Chemistry — first-principles molecular & quantum-chemistry pipeline (Hartree–Fock, post-HF, DFT, multi-reference).
...
declare optional dependencies on `qfull-chemistry` even though it ships no code.
