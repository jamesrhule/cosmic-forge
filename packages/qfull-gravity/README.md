...
QFull-Gravity — gravitational-wave templates, numerical relativity, gravitational leptogenesis (extends UCGLE-F1).
...
declare optional dependencies on `qfull-gravity` even though it ships no code.
