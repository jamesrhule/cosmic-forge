...
QFull-HEP — high-energy phenomenology (Standard-Model and BSM cross-sections, neutrino sector, baryogenesis).
...
declare optional dependencies on `qfull-hep` even though it ships no code.
