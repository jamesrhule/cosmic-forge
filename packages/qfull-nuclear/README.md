...
QFull-Nuclear — ab-initio nuclear structure & reactions, EFT-based methods, NCSM/NCSMC.
...
declare optional dependencies on `qfull-nuclear` even though it ships no code.
