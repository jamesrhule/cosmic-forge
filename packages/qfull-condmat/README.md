...
QFull-CondMat — condensed-matter many-body methods (DMFT, tensor networks, lattice MC).
...
declare optional dependencies on `qfull-condmat` even though it ships no code.
